/**
 * Tier 1 classification: classify fields by their option content.
 * Fields with options (select/radio/checkbox-group/button-group) carry
 * strong classification signal — a select with ["Male", "Female", "Non-binary"]
 * is gender regardless of what the label says.
 *
 * Uses alias data from aliases.json to recognize option text variants.
 * Returns null for Yes/No fields (need label context from Tier 2/3).
 */
